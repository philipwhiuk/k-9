...
import org.openintents.smime.util.ParcelFileDescriptorUtil.DataSinkTransferThread;
import org.openintents.smime.util.ParcelFileDescriptorUtil.DataSourceTransferThread;
...
public class SMimeApi {
    ...
    public <T> CancelableBackgroundOperation executeApiAsync(
            Intent data, SMimeDataSource dataSource, SMimeDataSink<T> dataSink,
            final ISMimeSinkResultCallback<T> callback) {
