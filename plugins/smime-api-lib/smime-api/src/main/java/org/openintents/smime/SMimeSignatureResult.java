...
public class SMimeSignatureResult implements Parcelable {
    ...
    private SMimeSignatureResult(int signatureStatus, String signatureUserId, long keyId,
    ...
    public static final Creator<SMimeSignatureResult> CREATOR = new Creator<SMimeSignatureResult>() {
        public SMimeSignatureResult createFromParcel(final Parcel source) {
            ...
            SMimeSignatureResult vr = new SMimeSignatureResult(source, version);
    ...
    public static SMimeSignatureResult createWithValidSignature(int signatureStatus, String primaryUserId,
        ...
        return new SMimeSignatureResult(
                signatureStatus, primaryUserId, keyId, userIds, confirmedUserIds, senderStatus, null);
    }

    public static SMimeSignatureResult createWithNoSignature() {
        return new SMimeSignatureResult(RESULT_NO_SIGNATURE, null, 0L, null, null, 0, null);
    }

    public static SMimeSignatureResult createWithKeyMissing(long keyId) {
        return new SMimeSignatureResult(RESULT_KEY_MISSING, null, keyId, null, null, 0, null);
    }

    public static SMimeSignatureResult createWithInvalidSignature() {
        return new SMimeSignatureResult(RESULT_INVALID_SIGNATURE, null, 0L, null, null, 0, null);
    }

    @Deprecated
    public SMimeSignatureResult withSignatureOnlyFlag(boolean signatureOnly) {
        return new SMimeSignatureResult(
