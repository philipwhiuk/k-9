...
package com.whiuk.philip.org.apache.http.conn.ssl;
...
public class SSLConnectionSocketFactory implements LayeredConnectionSocketFactory {
    ...
    public Socket connectSocket(
        ...
        try {
            ...
            Timber.d("Connecting socket to " + remoteAddress + " with timeout " + connectTimeout);
    ...
    private void verifyHostname(final SSLSocket sslsock, final String hostname) throws IOException {
        try {
            ...
            if (session == null) {
                ...
                Timber.d("Secure session established");
                Timber.d(" negotiated protocol: " + session.getProtocol());
                Timber.d(" negotiated cipher suite: " + session.getCipherSuite());
                ...
                try {
                    ...
                    Timber.d(" peer principal: " + peer.toString());
                    ...
                    if (altNames1 != null) {
                        ...
                        Timber.d(" peer alternative names: " + altNames);
                    }
