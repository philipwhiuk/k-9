...
import com.whiuk.philip.org.apache.http.HttpEntityEnclosingRequest;
...
import com.whiuk.philip.org.apache.http.client.NonRepeatableRequestException;
...
import com.whiuk.philip.org.apache.http.client.methods.CloseableHttpResponse;
import com.whiuk.philip.org.apache.http.client.methods.HttpExecutionAware;
import com.whiuk.philip.org.apache.http.client.methods.HttpRequestWrapper;
...
import com.whiuk.philip.org.apache.http.conn.ConnectionRequest;
import com.whiuk.philip.org.apache.http.conn.HttpClientConnectionManager;
import com.whiuk.philip.org.apache.http.conn.routing.BasicRouteDirector;
import com.whiuk.philip.org.apache.http.conn.routing.HttpRoute;
import com.whiuk.philip.org.apache.http.conn.routing.HttpRouteDirector;
import com.whiuk.philip.org.apache.http.conn.routing.RouteTracker;
...
import com.whiuk.philip.org.apache.http.impl.conn.ConnectionShutdownException;
    ...
    public CloseableHttpResponse execute(
        ...
        if (config.isStaleConnectionCheckEnabled()) {
            ...
            if (managedConn.isOpen()) {
                Timber.d("Stale connection check");
                if (managedConn.isStale()) {
                    Timber.d("Stale connection detected");
                    managedConn.close();
                }
            }
        }
        ...
        try {
            ...
            for (int execCount = 1;; execCount++) {
                ...
                if (!managedConn.isOpen()) {
                    Timber.d("Opening connection " + route);
                    try {
                ...
                if (execAware != null && execAware.isAborted()) {
                    ...
                    Timber.d("Executing request " + request.getRequestLine());

                if (!request.containsHeader(AUTH.WWW_AUTH_RESP)) {
                        Timber.d("Target auth state: " + targetAuthState.getState());
                    this.authenticator.generateAuthResponse(request, targetAuthState, context);
                }
                if (!request.containsHeader(AUTH.PROXY_AUTH_RESP) && !route.isTunnelled()) {
                        Timber.d("Proxy auth state: " + proxyAuthState.getState());
                ...
                if (reuseStrategy.keepAlive(response, context)) {
                    ...
                    final long duration = keepAliveStrategy.getKeepAliveDuration(response, context);
                        ...
                        Timber.d("Connection can be kept alive %s", s);
                ...
                if (needAuthentication(
                    ...
                    if (connHolder.isReusable()) {
                        ...
                        if (proxyAuthState.getState() == AuthProtocolState.SUCCESS
                            ...
                            Timber.d("Resetting proxy auth state");
                            proxyAuthState.reset();
                        }
                        if (targetAuthState.getState() == AuthProtocolState.SUCCESS
                                && targetAuthState.getAuthScheme() != null
                                && targetAuthState.getAuthScheme().isConnectionBased()) {
                            Timber.d("Resetting target auth state");
    ...
    void establishRoute(
        ...
        do {
            ...
            case HttpRouteDirector.TUNNEL_TARGET: {
                ...
                Timber.d("Tunnel to target created.");
            ...
            case HttpRouteDirector.TUNNEL_PROXY: {
                ...
                Timber.d("Tunnel to proxy created.");
                ...
                if (this.authenticator.isAuthenticationRequested(proxy, response,
                    ...
                    if (this.authenticator.handleAuthChallenge(proxy, response,
                        ...
                        if (this.reuseStrategy.keepAlive(response, context)) {
                            Timber.d("Connection kept alive");
