...
import com.whiuk.philip.org.apache.http.client.RedirectException;
        ...
        for (int redirectCount = 0;;) {
            ...
            try {
                if (config.isRedirectsEnabled() &&
                    ...
                    Timber.d("Redirecting to '" + uri + "' via " + currentRoute);
                ...
                try {
                    ...
                    Timber.d("I/O error while releasing connection", ioex);
                } finally {
                    response.close();
                }
                throw ex;
