...
import com.whiuk.philip.org.apache.http.client.HttpClient;
import com.whiuk.philip.org.apache.http.client.ResponseHandler;
    ...
    public <T> T execute(final HttpHost target, final HttpRequest request,
        ...
        try {
            ...
            try {
                ...
                Timber.w(t2, "Error consuming content after an exception.");
            }
            throw t;
        } finally {
            response.close();
