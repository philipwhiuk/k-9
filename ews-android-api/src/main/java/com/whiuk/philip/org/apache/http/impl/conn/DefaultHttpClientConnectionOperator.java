...
import com.whiuk.philip.org.apache.http.conn.ConnectTimeoutException;
...
import com.whiuk.philip.org.apache.http.conn.HttpHostConnectException;
...
import com.whiuk.philip.org.apache.http.conn.UnsupportedSchemeException;
...
public class DefaultHttpClientConnectionOperator implements HttpClientConnectionOperator {
    ...
    public void connect(
        ...
        for (int i = 0; i < addresses.length; i++) {
            ...
            Timber.d("Connecting to " + remoteAddress);
            try {
                sock = sf.connectSocket(
                        connectTimeout, sock, host, remoteAddress, localAddress, context);
                conn.bind(sock);
                    Timber.d("Connection established " + conn);
                return;
                ...
                Timber.d("Connect to " + remoteAddress + " timed out. " +
