...
public class RequestAddCookies implements HttpRequestInterceptor {
    ...
    public void process(final HttpRequest request, final HttpContext context)
        ...
        if (cookieStore == null) {
            Timber.d("Cookie store not specified in HTTP context");
            return;
        }
        ...
        if (registry == null) {
            Timber.d("CookieSpec registry not specified in HTTP context");
            return;
        }
        ...
        if (route == null) {
            Timber.d("Connection route not set in the context");
            return;
        }
        ...
        Timber.d("CookieSpec selected: " + policy);
        ...
        if (provider == null) {
            Timber.d("Unsupported cookie policy: " + policy);
        ...
        for (final Cookie cookie : cookies) {
            if (!cookie.isExpired(now)) {
                if (cookieSpec.match(cookie, cookieOrigin)) {
                    Timber.d("Cookie " + cookie + " match " + cookieOrigin);
                    matchedCookies.add(cookie);
                }
            } else {
                Timber.d("Cookie " + cookie + " expired");
                expired = true;
            }
        }
        // Per RFC 6265, 5.3
