    ...
    public void put(final HttpHost host, final AuthScheme authScheme) {
        ...
        if (authScheme instanceof Serializable) {
            try {
                ...
                Timber.w(ex, "Unexpected I/O error while serializing auth scheme");
            }
        } else {
            Timber.d("Auth scheme " + authScheme.getClass() + " is not serializable");
        }
    }
    ...
    public AuthScheme get(final HttpHost host) {
        ...
        if (bytes != null) {
            try {
                ...
                Timber.w(ex,"Unexpected I/O error while de-serializing auth scheme");
                return null;
            } catch (ClassNotFoundException ex) {
                Timber.w(ex,"Unexpected error while de-serializing auth scheme");
                return null;
            }
        } else {
            return null;
