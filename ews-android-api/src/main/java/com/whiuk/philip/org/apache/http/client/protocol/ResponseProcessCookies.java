...
public class ResponseProcessCookies implements HttpResponseInterceptor {
    ...
    public void process(final HttpResponse response, final HttpContext context)
        ...
        if (cookieSpec == null) {
            Timber.d("Cookie spec not specified in HTTP context");
            return;
        }
        // Obtain cookie store
        ...
        if (cookieOrigin == null) {
            Timber.d("Cookie origin not specified in HTTP context");
            return;
        }
                ...
                for (final Cookie cookie : cookies) {
                    try {
                        ...
                        cookieStore.addCookie(cookie);
                            ...
                            Timber.d("Cookie accepted [" + formatCooke(cookie) + "]");
                    } catch (final MalformedCookieException ex) {
                            Timber.w("Cookie rejected [" + formatCooke(cookie) + "] "
                                    + ex.getMessage());
                    }
                }
            } catch (final MalformedCookieException ex) {
                Timber.w("Invalid cookie header: \""
