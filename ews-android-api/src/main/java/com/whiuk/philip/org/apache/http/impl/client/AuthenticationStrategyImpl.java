...
import com.whiuk.philip.org.apache.http.auth.AuthOption;
...
abstract class AuthenticationStrategyImpl implements AuthenticationStrategy {
    ...
    public Queue<AuthOption> select(
        ...
        if (registry == null) {
            Timber.d("Auth scheme registry not set in the context");
            return options;
        }
        ...
        Timber.d("Authentication schemes in the order of preference: %s", authPrefs);
        ...
        for (final String id: authPrefs) {
            ...
            if (challenge != null) {
                ...
                if (authSchemeProvider == null) {
                    Timber.w("Authentication scheme " + id + " not supported");
                    // Try again
                    continue;
                }
                ...
                Timber.d("Challenge for " + id + " authentication scheme not available");
                // Try again
            }
        }
        return options;
    ...
    public void authSucceeded(
        ...
        if (isCachable(authScheme)) {
            ...
            Timber.d("Caching '" + authScheme.getSchemeName() +
    ...
    public void authFailed(
        ...
        if (authCache != null) {
            Timber.d("Clearing cached auth scheme for %s", authhost);
