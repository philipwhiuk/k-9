...
import com.whiuk.philip.org.apache.http.auth.UsernamePasswordCredentials;
...
import com.whiuk.philip.org.apache.http.impl.client.BasicCredentialsProvider;
...
public class ProtocolExec implements ClientExecChain {
    ...
    public CloseableHttpResponse execute(
        ...
        if (original instanceof HttpUriRequest) {
            ...
            try {
                uri = URI.create(uriString);
                    ...
                    Timber.d(ex,"Unable to parse '" + uriString + "' as a valid URI; " +
        ...
        if (virtualHost != null && virtualHost.getPort() == -1) {
            ...
            Timber.d("Using virtual host" + virtualHost);
        }
