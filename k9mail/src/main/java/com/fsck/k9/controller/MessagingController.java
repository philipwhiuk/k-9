...
import com.fsck.k9.controller.tasks.LoadMessageRemoteTask;
...
import com.fsck.k9.controller.tasks.SendPendingMessagesTask;
...
public class MessagingController implements IMessageController {
    ...
    public static synchronized MessagingController getInstance(Context context) {
        if (inst == null) {
            ...
            inst = new MessagingController(appContext, notificationController, contacts, transportProvider,
                    new SearchResultsLoader(), messageDownloader);
        }
        return inst;
    }
    ...
    MessagingController(Context context, NotificationController notificationController,
            ...
            SearchResultsLoader searchResultsLoader, MessageDownloader messageDownloader) {
    ...
    void synchronizeMailboxSynchronousLegacy(Account account, String folder, MessagingListener listener) {
        ...
        try {
             ...
             */
            int newMessages = messageDownloader.downloadMessages(this,
                    notificationController,
                    context, account, remoteFolder, localFolder, remoteMessages,
                    false, true, listeners);
    ...
    private String getRootCauseMessage(Throwable t) {
        return ControllerUtils.getRootCauseMessage(t);
    }

    //TODO: Visible for send task
    public void queuePendingCommand(Account account, PendingCommand command) {
        try {
            LocalStore localStore = account.getLocalStore();
    ...
    public void loadMessageRemotePartial(final Account account, final String folder,
        ...
        put("loadMessageRemotePartial", listener, new LoadMessageRemoteTask(this, context, notificationController,
                listeners, messageDownloader, account, folder, uid, listener, true));
    }
    ...
    public void loadMessageRemote(final Account account, final String folder,
            final String uid, final MessagingListener listener) {
        put("loadMessageRemote", listener, new LoadMessageRemoteTask(this, context, notificationController,
                listeners, messageDownloader, account, folder, uid, listener, false));
    }
    ...
    public void sendPendingMessages(final Account account,
        ...
        putBackground("sendPendingMessages", listener,
                new SendPendingMessagesTask(this, context,
                        notificationController, transportProvider,
                        sendCount, account, listeners));
    }
    ...
    //TODO: Not really core controller functionality - move
    @Override
        ...
        putBackground("Push messageArrived of account " + account.getDescription()
            ...
            public void run() {
                ...
                try {
                    ...
                    account.setRingNotified(false);
                    int newCount = messageDownloader.downloadMessages(MessagingController.this,
                            notificationController, context, account, remoteFolder, localFolder, messages,
                            flagSyncOnly, true, listeners);
