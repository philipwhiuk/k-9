...
public class MessagingControllerCommands {
    ...
    public static final String COMMAND_MARK_ALL_AS_READ = "mark_all_as_read";
    public static final String COMMAND_SET_FLAG = "set_flag";
    public static final String COMMAND_EXPUNGE = "expunge";
    public static final String COMMAND_MOVE_OR_COPY = "move_or_copy";
    public static final String COMMAND_EMPTY_TRASH = "empty_trash";
