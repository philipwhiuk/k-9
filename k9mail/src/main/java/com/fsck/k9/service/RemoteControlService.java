...
public class RemoteControlService extends CoreService {
    ...
    public int startService(final Intent intent, final int startId) {
        ...
        if (PUSH_RESTART_ACTION.equals(intent.getAction())) {
            ...
            execute(getApplication(), new ChangeSettingsRunnable(intent, preferences),
    ...
    private class ChangeSettingsRunnable implements Runnable {
        private final Intent intent;
        private final Preferences preferences;

        private boolean needsReschedule;
        private boolean needsPushRestart;

        ChangeSettingsRunnable(Intent intent, Preferences preferences) {
            this.intent = intent;
