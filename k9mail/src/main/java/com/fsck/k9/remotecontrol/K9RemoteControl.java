...
/**
 * Utillity definitions for Android applications to control the behavior of K-9 Mail.
 * All such applications must declare the following permission:
 * <uses-permission android:name="com.fsck.k9.permission.REMOTE_CONTROL"/>
 * in their AndroidManifest.xml  In addition, all applications sending remote control messages to
 * K-9 Mail must
 *
 * An application that wishes to act on a particular Account in K-9 needs to fetch the list of
 * configured Accounts by broadcasting an
 * {@link Intent} using K9_REQUEST_ACCOUNTS as the Action.  The broadcast must be made using the
 * {@link android.content.ContextWrapper#sendOrderedBroadcast(Intent, String,
 * android.content.BroadcastReceiver, android.os.Handler, int, String, android.os.Bundle)}
...
public class K9RemoteControl {
    ...
    /**
     * {@link Intent} Action to be sent to K-9 using {@link android.content.ContextWrapper#sendOrderedBroadcast(Intent, String,
     * android.content.BroadcastReceiver, android.os.Handler, int, String, android.os.Bundle)}
    ...
    public static void fetchAccounts(Context context, K9AccountReceptor receptor) {
        ...
        context.sendOrderedBroadcast(accountFetchIntent, K9RemoteControl.K9_REMOTE_CONTROL_PERMISSION,
