...
public class ICalendarPublishView extends ICalendarView implements View.OnClickListener, View.OnLongClickListener {
    ...
    public ICalendarPublishView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public void setICalendar(ICalendarViewInfo iCalendar, int index) {
        this.iCalendar = iCalendar;
        this.iCalendarIndex = index;
