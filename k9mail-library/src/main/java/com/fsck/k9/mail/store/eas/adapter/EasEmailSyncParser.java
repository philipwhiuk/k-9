...
import com.fsck.k9.mail.store.eas.EasStore.EasMessage;
...
public class EasEmailSyncParser extends AbstractSyncParser {
    ...
    public EasEmailSyncParser(InputStream in, EasFolder folder) throws IOException {
        super(in, folder);
    }
...
//                        msg.setInternalDate(receivedDate);
            ...
            case Tags.EMAIL_BODY:
                //TODO: Encoding
                //TODO: Memory is okay?
                Body body = new BinaryMemoryBody(getValue().getBytes(), "US-ASCII");
                msg.setBody(body);
                break;
