...
public class DNSOperation {
    public MXRecord mxLookup(String domain) throws TextParseException, UnknownHostException {
    ...
    @NonNull
    public List<SRVRecord> srvLookup(String serviceName) throws TextParseException, UnknownHostException {
    ...
    @Nullable
    public SRVRecord choose(@NonNull List<SRVRecord> srvRecords) {
