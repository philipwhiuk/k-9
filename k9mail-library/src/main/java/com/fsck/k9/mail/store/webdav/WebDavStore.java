...
public class WebDavStore extends RemoteStore {
    ...
    public List<? extends Folder> getPersonalNamespaces(boolean forceListAll) throws MessagingException {
        ...
        headers.put("Depth", "0");
        headers.put("Brief", "t");
        DataSet dataset = processRequest(this.mUrl, "PROPFIND", WebDavXmlBuilders.getSpecialFoldersList(), headers);
        ...
        */
        ...
        headers.put("Brief", "t");
        dataset = processRequest(this.mUrl, "SEARCH", WebDavXmlBuilders.getFolderListXml(this.mUrl), headers);
